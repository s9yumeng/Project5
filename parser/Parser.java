...
public class Parser {
	...
	/**
	 * Parses this translation unit.
	 * Each AST-node is generated by a call to the corresponding method of the ASTFactory.
	 */
	...
	private Expression parseExpression(final Precedence precedence) {
		...
		for (;;) {
			...
			nextToken();
			switch (kind) {
			case LBRACKET:      expr = parseArrayAccess(expr, t);           break;
			case LPAREN:        expr = parseFunctionCall(expr, t);          break;
			case QUESTION_MARK: expr = parseConditionalExpression(expr, t); break;
	...
	private Statement parseStatement(final boolean inner) {
		...
		case SEMICOLON: return parseEmpty();
