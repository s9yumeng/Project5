...
public interface ASTFactory {
	...
	/**
	 * Creates a block statement with the given location.
	 * This block contains the given list of statements.
	 * Example:
	 * {
	 *     statement*
	 * }
	...
	/**
	 * Creates a break statement with the given location.
	...
	/**
	 * Creates a continue statement with the given location.
	 * @param loc The given location of this statement.
	 * Example:
	 *     continue;
	 ...
	 * Use the location of {@code name} for the location of this statement. 
	...
	/**
	 * Creates an error statement with the given location (BONUS exercise).
	 * An error statement represents an invalid statement which is reported by the parser.
	 * For instance, an error statement will be emitted in the following case:
	 *     if (a > 5) else ...
	 * The if statement expects an additional statement after parsing the conditional
	 * expression (in parentheses) which is not given is this case, as the else keyword is detected.
	 * So for the consequence an error statement is inserted.
	 * @param loc The given location of this statement.
	 ...
	 * @param token The opening parenthesis token of this call expression (used for the location).
	 ...
	 * @param token The question mark token of this conditional expression (used for the location).
	 ...
	 * @param postfix True if this is a postfix operator, false in the case of a prefix operator.
	 *                Postfix must be handled for a BONUS exercise.
	...
	/**
	 * Creates a declaration for a global variable or function with the given type and name.
	 * Example:
	 *     int globalVariable;
	 *     Name: globalVariable
	 *     Type: int
	...
	/**
	 * Creates a function definition with the given type, function name, parameter names and its body.
	 * Example definition:
